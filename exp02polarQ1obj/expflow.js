...
function make_slides(f) {
  ...
  slides.ex = slide({
    ...
    /* trial information for this block
     (the variable 'stim' will change between each of these values,
      and for each of these, present_handle will be run.) */
    present : _.shuffle([{noun: "star", adjective: "blue",
                          fileinit: "starBlue", range:[9],
                          surprising: function(x){return(x < .8)}},
                         {noun: "star", adjective: "blue",
                         fileinit: "starBlue", range:[1],
    ...
    present_handle : function(stim) {
      ...
      // set image to loading icon
      $("#ex-img").attr("src", "../stimuli/loading.jpg");
      ...
      $("#ex-description").html("Is this " + stim.noun + " " + stim.adjective + "?");
    },
  ...
  slides.critical = slide({
    ...
    present_handle : function(stim) {
      ...
      // set image to loading icon
      $("#critical-img").attr("src", "../stimuli/loading.jpg");
      // uncheck the radio buttons
      ...
      $("#critical-description").html("Is this " + stim.noun + " " + stim.adjective + "?");
    },
